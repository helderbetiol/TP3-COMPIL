...
public class CalcParser extends Parser {
	...
	public final ExpressionContext expression() throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << IDENTIFIER) | (1L << INTEGER))) != 0)) {
					{
					{
					setState(78);
					expression();
	...
	public static class UnExp2Context extends TailContext {
		public UnExp2Context(TailContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalcVisitor ) return ((CalcVisitor<? extends T>)visitor).visitUnExp2(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class BinExp2Context extends TailContext {
		public ExpressionContext expression() {
			return getRuleContext(ExpressionContext.class,0);
		}
		public BinExp2Context(TailContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalcVisitor ) return ((CalcVisitor<? extends T>)visitor).visitBinExp2(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final TailContext tail() throws RecognitionException {
		...
		try {
			...
			switch (_input.LA(1)) {
			case T__2:
				_localctx = new UnExp2Context(_localctx);
				enterOuterAlt(_localctx, 1);
				{
				setState(88);
				match(T__2);
			...
			case IDENTIFIER:
			case INTEGER:
				_localctx = new BinExp2Context(_localctx);
				enterOuterAlt(_localctx, 2);
				{
				setState(89);
				expression();
